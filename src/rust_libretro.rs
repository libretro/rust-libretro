...
extern "C" fn retro_serialize_size() -> size_t { 0 }
extern "C" fn retro_serialize(_data: *mut u8, _size: size_t) -> u8 { false as u8 }
extern "C" fn retro_unserialize(_data: *const u8, _size: size_t) -> u8 { false as u8 }
extern "C" fn retro_cheat_reset() {}
extern "C" fn retro_cheat_set(_index: c_uint, _enabled: u8, _code: *const u8) {}
extern "C" fn retro_load_game_special(_type: c_uint, _info: *const retro_game_info, _num: size_t) -> u8 { false as u8 }
extern "C" fn retro_unload_game() {}
extern "C" fn retro_get_region() -> c_uint { RETRO_REGION_NTSC }
extern "C" fn retro_get_memory_data(_id: c_uint) -> *mut u8 {	core::ptr::null_mut() }
extern "C" fn retro_get_memory_size(_id: c_uint) -> size_t { 0 }
extern "C" fn retro_load_game(_info: *const u8) -> u8 { true as u8}
